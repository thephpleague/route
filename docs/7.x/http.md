...
Read more about middleware [here](/7.x/middleware).
...
See more about controllers [here](/7.x/controllers).
...
Once wrapped, your controller ultimately becomes the last middleware in the stack (this does not mean that it has to be invoked last, see [middleware](/7.x/middleware) for more on this), it just means that it will only be concerned with creating and returning a response object.
