...
class JsonStrategyTest extends TestCase
{
    ...
    /**
     * Asserts that the strategy properly invokes the route callable with a JsonSerializable object return.
     *
     * @return void
     */
    public function testStrategyInvokesRouteCallableWithJsonSerializableReturn() : void
    {
        $route = $this->createMock(Route::class);
        ...
        $body             = $this->createMock(StreamInterface::class);
        $expectedVars     = ['something', 'else'];
        $expectedObject = $this->createMock(JsonSerializable::class);
        ...
        $expectedObject
            ...
            ->will($this->returnValue([$expectedVars[0] => $expectedVars[1]]));
